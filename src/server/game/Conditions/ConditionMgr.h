...
enum ConditionSourceType
{
    ...
    CONDITION_SOURCE_TYPE_MILLING_LOOT_TEMPLATE          = 7, //! TrinityZero: will removing this cause problems?
    CONDITION_SOURCE_TYPE_PICKPOCKETING_LOOT_TEMPLATE    = 8,
    CONDITION_SOURCE_TYPE_PROSPECTING_LOOT_TEMPLATE      = 9, //! TrinityZero: will removing this cause problems?
