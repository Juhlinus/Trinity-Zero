...
enum WorldFloatConfigs
{
    ...
    CONFIG_MAX_RECRUIT_A_FRIEND_DISTANCE, //! TrinityZero note: will removing this cause problems?
...
enum Rates
{
    ...
    RATE_REPUTATION_RECRUIT_A_FRIEND_BONUS, //! TrinityZero note: will removing this cause problems?
