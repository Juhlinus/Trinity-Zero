...
enum EventFlags
{
    ...
    EFLAG_DIFFICULTY_0          = 0x02,                     //Event only occurs in instance difficulty 0 (normal dungeon)
    EFLAG_DIFFICULTY_1          = 0x04,                     //Event only occurs in instance difficulty 1 (20m raid)
    EFLAG_DIFFICULTY_2          = 0x08,                     //Event only occurs in instance difficulty 2 (40m raid)
    EFLAG_DIFFICULTY_3          = 0x10,                     //Event only occurs in instance difficulty 3 (UNUSED)
